...
// source: lorawan-stack-legacy/api/router.proto

package ttnpb // import "go.thethings.network/lorawan-stack-legacy/pkg/ttnpb"
...
func (Modulation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{0}
}
...
func (LocationMetadata_LocationSource) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{7, 0}
}

type UplinkMessage struct {
	Payload []byte `protobuf:"bytes,1,opt,name=payload,proto3" json:"payload,omitempty"`
	// ProtocolMessage message = 2;
	ProtocolMetadata     ProtocolRxMetadata `protobuf:"bytes,11,opt,name=protocol_metadata,json=protocolMetadata" json:"protocol_metadata"`
	GatewayMetadata      GatewayRxMetadata  `protobuf:"bytes,12,opt,name=gateway_metadata,json=gatewayMetadata" json:"gateway_metadata"`
	Trace                *Trace             `protobuf:"bytes,21,opt,name=trace" json:"trace,omitempty"`
...
type DownlinkMessage struct {
	Payload []byte `protobuf:"bytes,1,opt,name=payload,proto3" json:"payload,omitempty"`
	// ProtocolMessage message = 2;
	ProtocolConfiguration ProtocolTxConfiguration `protobuf:"bytes,11,opt,name=protocol_configuration,json=protocolConfiguration" json:"protocol_configuration"`
	GatewayConfiguration  GatewayTxConfiguration  `protobuf:"bytes,12,opt,name=gateway_configuration,json=gatewayConfiguration" json:"gateway_configuration"`
	Trace                 *Trace                  `protobuf:"bytes,21,opt,name=trace" json:"trace,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                `json:"-"`
	XXX_sizecache         int32                   `json:"-"`
}
...
func (*DownlinkMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{1}
}
...
func (*Trace) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{2}
}
...
type ProtocolRxMetadata struct {
	LoRaWAN              *LoRaWANMetadata `protobuf:"bytes,1,opt,name=lorawan" json:"lorawan,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*ProtocolRxMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{3}
}
...
func (dst *ProtocolRxMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolRxMetadata.Merge(dst, src)
}
...
type ProtocolTxConfiguration struct {
	LoRaWAN              *LoRaWANTxConfiguration `protobuf:"bytes,1,opt,name=lorawan" json:"lorawan,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (*ProtocolTxConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{4}
}
...
func (dst *ProtocolTxConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolTxConfiguration.Merge(dst, src)
}
...
type LoRaWANMetadata struct {
	Modulation           Modulation `protobuf:"varint,11,opt,name=modulation,proto3,enum=ttn.lorawan.v2.Modulation" json:"modulation,omitempty"`
...
func (*LoRaWANMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{5}
}
...
func (dst *LoRaWANMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LoRaWANMetadata.Merge(dst, src)
}
...
func (*LoRaWANTxConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{6}
}
...
func (dst *LoRaWANTxConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LoRaWANTxConfiguration.Merge(dst, src)
}
...
type LocationMetadata struct {
	...
	Source               LocationMetadata_LocationSource `protobuf:"varint,6,opt,name=source,proto3,enum=ttn.lorawan.v2.LocationMetadata_LocationSource" json:"source,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                        `json:"-"`
	XXX_sizecache        int32                           `json:"-"`
}
...
func (*LocationMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{7}
}
...
type GatewayRxMetadata struct {
	...
	Antennas             []*GatewayRxMetadata_Antenna `protobuf:"bytes,30,rep,name=antennas" json:"antennas,omitempty"`
...
func (*GatewayRxMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{8}
}
...
func (dst *GatewayRxMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayRxMetadata.Merge(dst, src)
}
...
func (*GatewayRxMetadata_Antenna) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{8, 0}
}
...
func (dst *GatewayRxMetadata_Antenna) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayRxMetadata_Antenna.Merge(dst, src)
}
...
func (*GatewayTxConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{9}
}
...
func (dst *GatewayTxConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayTxConfiguration.Merge(dst, src)
}
...
type StatusMessage struct {
	...
	OS                   *StatusMessage_OSMetrics `protobuf:"bytes,51,opt,name=os" json:"os,omitempty"`
...
func (*StatusMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{10}
}
...
func (*StatusMessage_OSMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_8dbc2f7524807fe9, []int{10, 0}
}
...
func (dst *StatusMessage_OSMetrics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatusMessage_OSMetrics.Merge(dst, src)
}
...
func init() {
	proto.RegisterType((*UplinkMessage)(nil), "ttn.lorawan.v2.UplinkMessage")
	golang_proto.RegisterType((*UplinkMessage)(nil), "ttn.lorawan.v2.UplinkMessage")
	proto.RegisterType((*DownlinkMessage)(nil), "ttn.lorawan.v2.DownlinkMessage")
	golang_proto.RegisterType((*DownlinkMessage)(nil), "ttn.lorawan.v2.DownlinkMessage")
	proto.RegisterType((*Trace)(nil), "ttn.lorawan.v2.Trace")
	golang_proto.RegisterType((*Trace)(nil), "ttn.lorawan.v2.Trace")
	proto.RegisterMapType((map[string]string)(nil), "ttn.lorawan.v2.Trace.MetadataEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ttn.lorawan.v2.Trace.MetadataEntry")
	proto.RegisterType((*ProtocolRxMetadata)(nil), "ttn.lorawan.v2.ProtocolRxMetadata")
	golang_proto.RegisterType((*ProtocolRxMetadata)(nil), "ttn.lorawan.v2.ProtocolRxMetadata")
	proto.RegisterType((*ProtocolTxConfiguration)(nil), "ttn.lorawan.v2.ProtocolTxConfiguration")
	golang_proto.RegisterType((*ProtocolTxConfiguration)(nil), "ttn.lorawan.v2.ProtocolTxConfiguration")
	proto.RegisterType((*LoRaWANMetadata)(nil), "ttn.lorawan.v2.LoRaWANMetadata")
	golang_proto.RegisterType((*LoRaWANMetadata)(nil), "ttn.lorawan.v2.LoRaWANMetadata")
	proto.RegisterType((*LoRaWANTxConfiguration)(nil), "ttn.lorawan.v2.LoRaWANTxConfiguration")
	golang_proto.RegisterType((*LoRaWANTxConfiguration)(nil), "ttn.lorawan.v2.LoRaWANTxConfiguration")
	proto.RegisterType((*LocationMetadata)(nil), "ttn.lorawan.v2.LocationMetadata")
	golang_proto.RegisterType((*LocationMetadata)(nil), "ttn.lorawan.v2.LocationMetadata")
	proto.RegisterType((*GatewayRxMetadata)(nil), "ttn.lorawan.v2.GatewayRxMetadata")
	golang_proto.RegisterType((*GatewayRxMetadata)(nil), "ttn.lorawan.v2.GatewayRxMetadata")
	proto.RegisterType((*GatewayRxMetadata_Antenna)(nil), "ttn.lorawan.v2.GatewayRxMetadata.Antenna")
	golang_proto.RegisterType((*GatewayRxMetadata_Antenna)(nil), "ttn.lorawan.v2.GatewayRxMetadata.Antenna")
	proto.RegisterType((*GatewayTxConfiguration)(nil), "ttn.lorawan.v2.GatewayTxConfiguration")
	golang_proto.RegisterType((*GatewayTxConfiguration)(nil), "ttn.lorawan.v2.GatewayTxConfiguration")
	proto.RegisterType((*StatusMessage)(nil), "ttn.lorawan.v2.StatusMessage")
	golang_proto.RegisterType((*StatusMessage)(nil), "ttn.lorawan.v2.StatusMessage")
	proto.RegisterType((*StatusMessage_OSMetrics)(nil), "ttn.lorawan.v2.StatusMessage.OSMetrics")
	golang_proto.RegisterType((*StatusMessage_OSMetrics)(nil), "ttn.lorawan.v2.StatusMessage.OSMetrics")
	proto.RegisterEnum("ttn.lorawan.v2.Modulation", Modulation_name, Modulation_value)
	golang_proto.RegisterEnum("ttn.lorawan.v2.Modulation", Modulation_name, Modulation_value)
	proto.RegisterEnum("ttn.lorawan.v2.LocationMetadata_LocationSource", LocationMetadata_LocationSource_name, LocationMetadata_LocationSource_value)
	golang_proto.RegisterEnum("ttn.lorawan.v2.LocationMetadata_LocationSource", LocationMetadata_LocationSource_name, LocationMetadata_LocationSource_value)
}
...
func (this *ProtocolRxMetadata) Equal(that interface{}) bool {
	...
	that1, ok := that.(*ProtocolRxMetadata)
	if !ok {
		that2, ok := that.(ProtocolRxMetadata)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ProtocolTxConfiguration) Equal(that interface{}) bool {
	...
	that1, ok := that.(*ProtocolTxConfiguration)
	if !ok {
		that2, ok := that.(ProtocolTxConfiguration)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LoRaWANMetadata) Equal(that interface{}) bool {
	...
	that1, ok := that.(*LoRaWANMetadata)
	if !ok {
		that2, ok := that.(LoRaWANMetadata)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LoRaWANTxConfiguration) Equal(that interface{}) bool {
	...
	that1, ok := that.(*LoRaWANTxConfiguration)
	if !ok {
		that2, ok := that.(LoRaWANTxConfiguration)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GatewayRxMetadata) Equal(that interface{}) bool {
	...
	that1, ok := that.(*GatewayRxMetadata)
	if !ok {
		that2, ok := that.(GatewayRxMetadata)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GatewayRxMetadata_Antenna) Equal(that interface{}) bool {
	...
	that1, ok := that.(*GatewayRxMetadata_Antenna)
	if !ok {
		that2, ok := that.(GatewayRxMetadata_Antenna)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GatewayTxConfiguration) Equal(that interface{}) bool {
	...
	that1, ok := that.(*GatewayTxConfiguration)
	if !ok {
		that2, ok := that.(GatewayTxConfiguration)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StatusMessage) Equal(that interface{}) bool {
	...
	that1, ok := that.(*StatusMessage)
	if !ok {
		that2, ok := that.(StatusMessage)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StatusMessage_OSMetrics) Equal(that interface{}) bool {
	...
	that1, ok := that.(*StatusMessage_OSMetrics)
	if !ok {
		that2, ok := that.(StatusMessage_OSMetrics)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (c *routerClient) GatewayStatus(ctx context.Context, opts ...grpc.CallOption) (Router_GatewayStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Router_serviceDesc.Streams[0], "/ttn.lorawan.v2.Router/GatewayStatus", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) Uplink(ctx context.Context, opts ...grpc.CallOption) (Router_UplinkClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Router_serviceDesc.Streams[1], "/ttn.lorawan.v2.Router/Uplink", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) Subscribe(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (Router_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Router_serviceDesc.Streams[2], "/ttn.lorawan.v2.Router/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
var _Router_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ttn.lorawan.v2.Router",
	...
	Metadata: "lorawan-stack-legacy/api/router.proto",
}
...
func (m *Trace) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Metadata) > 0 {
		for k, _ := range m.Metadata {
			...
			i++
			v := m.Metadata[k]
			mapSize := 1 + len(k) + sovRouter(uint64(len(k))) + 1 + len(v) + sovRouter(uint64(len(v)))
...
func (m *ProtocolRxMetadata) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LoRaWAN != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRouter(dAtA, i, uint64(m.LoRaWAN.Size()))
		n7, err := m.LoRaWAN.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *GatewayRxMetadata) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Location != nil {
		...
		dAtA[i] = 0x2
		i++
		i = encodeVarintRouter(dAtA, i, uint64(m.Location.Size()))
...
func (m *StatusMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OS != nil {
		...
		dAtA[i] = 0x3
		i++
		i = encodeVarintRouter(dAtA, i, uint64(m.OS.Size()))
		n11, err := m.OS.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func NewPopulatedUplinkMessage(r randyRouter, easy bool) *UplinkMessage {
	...
	v2 := NewPopulatedProtocolRxMetadata(r, easy)
	this.ProtocolMetadata = *v2
	v3 := NewPopulatedGatewayRxMetadata(r, easy)
	this.GatewayMetadata = *v3
	if r.Intn(10) == 0 {
		this.Trace = NewPopulatedTrace(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedDownlinkMessage(r randyRouter, easy bool) *DownlinkMessage {
	...
	v5 := NewPopulatedProtocolTxConfiguration(r, easy)
	this.ProtocolConfiguration = *v5
	v6 := NewPopulatedGatewayTxConfiguration(r, easy)
...
func NewPopulatedTrace(r randyRouter, easy bool) *Trace {
	this := &Trace{}
	this.ID = string(randStringRouter(r))
	this.Time = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.Time *= -1
	}
	this.ServiceID = string(randStringRouter(r))
	this.ServiceName = string(randStringRouter(r))
	this.Event = string(randStringRouter(r))
	if r.Intn(10) != 0 {
		v7 := r.Intn(10)
		this.Metadata = make(map[string]string)
		for i := 0; i < v7; i++ {
			this.Metadata[randStringRouter(r)] = randStringRouter(r)
		}
	}
	if r.Intn(10) == 0 {
		v8 := r.Intn(5)
		this.Parents = make([]*Trace, v8)
		for i := 0; i < v8; i++ {
...
func NewPopulatedProtocolRxMetadata(r randyRouter, easy bool) *ProtocolRxMetadata {
	this := &ProtocolRxMetadata{}
	if r.Intn(10) != 0 {
		this.LoRaWAN = NewPopulatedLoRaWANMetadata(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedProtocolTxConfiguration(r randyRouter, easy bool) *ProtocolTxConfiguration {
	this := &ProtocolTxConfiguration{}
	if r.Intn(10) != 0 {
		this.LoRaWAN = NewPopulatedLoRaWANTxConfiguration(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedLoRaWANMetadata(r randyRouter, easy bool) *LoRaWANMetadata {
	this := &LoRaWANMetadata{}
	this.Modulation = Modulation([]int32{0, 1}[r.Intn(2)])
	this.DataRate = string(randStringRouter(r))
	this.BitRate = uint32(r.Uint32())
	this.CodingRate = string(randStringRouter(r))
	this.FCnt = uint32(r.Uint32())
	this.FrequencyPlan = uint32(r.Uint32())
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedGatewayRxMetadata(r randyRouter, easy bool) *GatewayRxMetadata {
	...
	v9 := r.Intn(100)
	this.EncryptedTime = make([]byte, v9)
	for i := 0; i < v9; i++ {
	...
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.Antennas = make([]*GatewayRxMetadata_Antenna, v10)
		for i := 0; i < v10; i++ {
			this.Antennas[i] = NewPopulatedGatewayRxMetadata_Antenna(r, easy)
		}
	}
...
func NewPopulatedGatewayRxMetadata_Antenna(r randyRouter, easy bool) *GatewayRxMetadata_Antenna {
	this := &GatewayRxMetadata_Antenna{}
	...
	v11 := r.Intn(100)
	this.EncryptedTime = make([]byte, v11)
	for i := 0; i < v11; i++ {
		this.EncryptedTime[i] = byte(r.Intn(256))
	}
...
func NewPopulatedStatusMessage(r randyRouter, easy bool) *StatusMessage {
	...
	v12 := r.Intn(10)
	this.IP = make([]string, v12)
	for i := 0; i < v12; i++ {
		this.IP[i] = string(randStringRouter(r))
	}
	this.Platform = string(randStringRouter(r))
	this.ContactEmail = string(randStringRouter(r))
	this.Description = string(randStringRouter(r))
	this.FrequencyPlan = string(randStringRouter(r))
	this.Bridge = string(randStringRouter(r))
	this.Router = string(randStringRouter(r))
	this.FPGA = uint32(r.Uint32())
	this.DSP = uint32(r.Uint32())
	this.HAL = string(randStringRouter(r))
	if r.Intn(10) != 0 {
		this.Location = NewPopulatedLocationMetadata(r, easy)
	}
	...
	if r.Intn(10) != 0 {
		this.OS = NewPopulatedStatusMessage_OSMetrics(r, easy)
	}
	v13 := r.Intn(10)
	this.Messages = make([]string, v13)
	for i := 0; i < v13; i++ {
		this.Messages[i] = string(randStringRouter(r))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldRouter(dAtA []byte, r randyRouter, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateRouter(dAtA, uint64(v15))
	case 1:
		dAtA = encodeVarintPopulateRouter(dAtA, uint64(key))
...
func (this *UplinkMessage) String() string {
	...
	s := strings.Join([]string{`&UplinkMessage{`,
		...
		`ProtocolMetadata:` + strings.Replace(strings.Replace(this.ProtocolMetadata.String(), "ProtocolRxMetadata", "ProtocolRxMetadata", 1), `&`, ``, 1) + `,`,
		`GatewayMetadata:` + strings.Replace(strings.Replace(this.GatewayMetadata.String(), "GatewayRxMetadata", "GatewayRxMetadata", 1), `&`, ``, 1) + `,`,
...
func (this *DownlinkMessage) String() string {
	...
	s := strings.Join([]string{`&DownlinkMessage{`,
		`Payload:` + fmt.Sprintf("%v", this.Payload) + `,`,
		`ProtocolConfiguration:` + strings.Replace(strings.Replace(this.ProtocolConfiguration.String(), "ProtocolTxConfiguration", "ProtocolTxConfiguration", 1), `&`, ``, 1) + `,`,
		`GatewayConfiguration:` + strings.Replace(strings.Replace(this.GatewayConfiguration.String(), "GatewayTxConfiguration", "GatewayTxConfiguration", 1), `&`, ``, 1) + `,`,
		`Trace:` + strings.Replace(fmt.Sprintf("%v", this.Trace), "Trace", "Trace", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ProtocolRxMetadata) String() string {
	...
	s := strings.Join([]string{`&ProtocolRxMetadata{`,
		`LoRaWAN:` + strings.Replace(fmt.Sprintf("%v", this.LoRaWAN), "LoRaWANMetadata", "LoRaWANMetadata", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ProtocolTxConfiguration) String() string {
	...
	s := strings.Join([]string{`&ProtocolTxConfiguration{`,
		`LoRaWAN:` + strings.Replace(fmt.Sprintf("%v", this.LoRaWAN), "LoRaWANTxConfiguration", "LoRaWANTxConfiguration", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *LoRaWANMetadata) String() string {
	...
	s := strings.Join([]string{`&LoRaWANMetadata{`,
...
func (this *LoRaWANTxConfiguration) String() string {
	...
	s := strings.Join([]string{`&LoRaWANTxConfiguration{`,
		`Modulation:` + fmt.Sprintf("%v", this.Modulation) + `,`,
		`DataRate:` + fmt.Sprintf("%v", this.DataRate) + `,`,
		`BitRate:` + fmt.Sprintf("%v", this.BitRate) + `,`,
		`CodingRate:` + fmt.Sprintf("%v", this.CodingRate) + `,`,
...
func (this *GatewayRxMetadata) String() string {
	...
	s := strings.Join([]string{`&GatewayRxMetadata{`,
		...
		`Antennas:` + strings.Replace(fmt.Sprintf("%v", this.Antennas), "GatewayRxMetadata_Antenna", "GatewayRxMetadata_Antenna", 1) + `,`,
...
func (this *GatewayRxMetadata_Antenna) String() string {
	...
	s := strings.Join([]string{`&GatewayRxMetadata_Antenna{`,
...
func (this *GatewayTxConfiguration) String() string {
	...
	s := strings.Join([]string{`&GatewayTxConfiguration{`,
		`Timestamp:` + fmt.Sprintf("%v", this.Timestamp) + `,`,
		`RfChain:` + fmt.Sprintf("%v", this.RfChain) + `,`,
		`Frequency:` + fmt.Sprintf("%v", this.Frequency) + `,`,
...
func (this *StatusMessage) String() string {
	...
	s := strings.Join([]string{`&StatusMessage{`,
		`Timestamp:` + fmt.Sprintf("%v", this.Timestamp) + `,`,
		`Time:` + fmt.Sprintf("%v", this.Time) + `,`,
		`GatewayTrusted:` + fmt.Sprintf("%v", this.GatewayTrusted) + `,`,
		...
		`OS:` + strings.Replace(fmt.Sprintf("%v", this.OS), "StatusMessage_OSMetrics", "StatusMessage_OSMetrics", 1) + `,`,
...
func (this *StatusMessage_OSMetrics) String() string {
	...
	s := strings.Join([]string{`&StatusMessage_OSMetrics{`,
...
func init() {
	proto.RegisterFile("lorawan-stack-legacy/api/router.proto", fileDescriptor_router_8dbc2f7524807fe9)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack-legacy/api/router.proto", fileDescriptor_router_8dbc2f7524807fe9)
}

var fileDescriptor_router_8dbc2f7524807fe9 = []byte{
	// 1925 bytes of a gzipped FileDescriptorProto
	,
}
