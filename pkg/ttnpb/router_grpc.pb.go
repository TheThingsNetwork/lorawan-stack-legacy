...
func (c *routerClient) GatewayStatus(ctx context.Context, opts ...grpc.CallOption) (Router_GatewayStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &Router_ServiceDesc.Streams[0], "/router.Router/GatewayStatus", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) Uplink(ctx context.Context, opts ...grpc.CallOption) (Router_UplinkClient, error) {
	stream, err := c.cc.NewStream(ctx, &Router_ServiceDesc.Streams[1], "/router.Router/Uplink", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) Subscribe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Router_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &Router_ServiceDesc.Streams[2], "/router.Router/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
