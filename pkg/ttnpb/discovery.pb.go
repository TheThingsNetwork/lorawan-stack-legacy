...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_discovery_774696bcff2e71eb, []int{0}
}
...
func (*Announcement) Descriptor() ([]byte, []int) {
	return fileDescriptor_discovery_774696bcff2e71eb, []int{1}
}
...
func NewPopulatedGetRequest(r randyDiscovery, easy bool) *GetRequest {
	this := &GetRequest{}
	this.ID = randStringDiscovery(r)
	this.ServiceName = randStringDiscovery(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedAnnouncement(r randyDiscovery, easy bool) *Announcement {
	...
	this.ID = randStringDiscovery(r)
	this.ServiceName = randStringDiscovery(r)
	this.ServiceVersion = randStringDiscovery(r)
	this.NetAddress = randStringDiscovery(r)
	this.PublicKey = randStringDiscovery(r)
	this.Certificate = randStringDiscovery(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func sozDiscovery(x uint64) (n int) {
	return sovDiscovery((x << 1) ^ uint64((int64(x) >> 63)))
}
...
func init() {
	proto.RegisterFile("lorawan-stack-legacy/api/discovery.proto", fileDescriptor_discovery_774696bcff2e71eb)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack-legacy/api/discovery.proto", fileDescriptor_discovery_774696bcff2e71eb)
}

var fileDescriptor_discovery_774696bcff2e71eb = []byte{
	// 441 bytes of a gzipped FileDescriptorProto
	,
}
